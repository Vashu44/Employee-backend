...
MAIL_USERNAME = os.getenv("MAIL_USERNAME", "hiteshbih1@gmail.com")
MAIL_PASSWORD = os.getenv("MAIL_PASSWORD", "hbnl ugjr xqni dgxu")
MAIL_FROM = os.getenv("MAIL_FROM", "hiteshbih1@gmail.com")
...
conf = ConnectionConfig(
    ...
    MAIL_PASSWORD=MAIL_PASSWORD, # type: ignore
    MAIL_FROM=MAIL_FROM,
    MAIL_PORT=MAIL_PORT,
